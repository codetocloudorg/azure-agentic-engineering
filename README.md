...
### `Azure AI Platforms` • `Agentic AI` • `GitHub-First DevOps`

<br>

<!-- 🚀 QUICK START WITH CODESPACES -->
<a href="https://codespaces.new/codetocloudorg/azure-agentic-engineering">
  <img src="https://img.shields.io/badge/🚀_Start_Engineering_in_Seconds-Open_in_Codespaces-181717?style=for-the-badge&logo=github" alt="Open in Codespaces">
</a>

<br>
<sub>Pre-configured dev environment • Python 3.12 • Azure CLI • Agent Framework • No setup required</sub>
<br><br>

<!-- BADGES ROW 1 - Identity -->
[![Code to Cloud](https://img.shields.io/badge/🚀_Code_to_Cloud-Organization-4A90D9?style=for-the-badge)](https://github.com/codetocloudorg)
...
[**🚀 Start Here**](docs/getting-started/) · [**☁️ Codespaces**](.devcontainer/) · [**📖 Docs**](docs/) · [**💻 Samples**](samples/) · [**🏗️ Architecture**](#-architecture-best-practices) · [**🤝 Contributing**](CONTRIBUTING.md)
...
- [Overview](#-overview)
- [🚀 Start Here](#-start-here---new-to-azure-ai)
...
> 💡 **Not Azure DevOps** — This repo is GitHub-focused. For Azure DevOps, see [Azure DevOps docs](https://learn.microsoft.com/azure/devops/).
...
[![Start Learning](https://img.shields.io/badge/🎯_START_HERE-Getting_Started_Guide-00D4AA?style=for-the-badge&logoColor=white)](docs/getting-started/)
...
> 💡 **Already familiar?** Jump to [Quick Start](#-quick-start) or [Resources](#-key-resources)
...
<details open>
<summary><strong>🛠️ Developer Tools & SDKs</strong></summary>

> **🤔 "Which SDK should I use?"** → [Full SDK Decision Guide](docs/sdks/README.md#-which-sdk-should-i-use)
...
<details>
<summary><strong>👁️ Observability & Monitoring</strong></summary>
...
<details>
<summary><strong>📊 Management & Operations</strong></summary>
...
<details>
<summary><strong>🐙 GitHub DevOps for AI</strong></summary>
...
<details>
<summary><strong>📐 Architecture References</strong></summary>
...
| Guide | Description |
|-------|-------------|
| [🆕 **Getting Started**](docs/getting-started/) | Step-by-step beginner learning path (~50 min) |
...
<details>
<summary><strong>🔌 When to Use APIM AI Gateway with Azure AI Foundry</strong></summary>

> **📢 New!** AI Gateway can now be [integrated directly into Microsoft Foundry](https://learn.microsoft.com/azure/ai-foundry/configuration/enable-ai-api-management-gateway-portal), enabling governance of AI models, agents, and tools from within your Foundry environment.
...
📖 [Security Best Practices Guide](docs/security/security-best-practices.md)
...
<img src="https://img.shields.io/badge/🚀_CODE_TO_CLOUD-Bridging_Dev_to_Production-4A90D9?style=for-the-badge" alt="Code to Cloud">
...
[![Report Bug](https://img.shields.io/badge/🐛_Report-Bug-red?style=flat-square)](../../issues)
[![Request Feature](https://img.shields.io/badge/💡_Request-Feature-green?style=flat-square)](../../issues)
[![Ask Question](https://img.shields.io/badge/💬_Ask-Question-blue?style=flat-square)](../../discussions)
...
**Built with ❤️ by [Code to Cloud](https://github.com/codetocloudorg) for the Azure AI Community**
...
<sub>If this repo helped you, consider giving it a ⭐!</sub>
